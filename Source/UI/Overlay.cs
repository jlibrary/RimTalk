...
namespace RimTalk.UI
{
    public class Overlay : MapComponent
    {
        ...
        private Dictionary<string, List<ApiLog>> _talkLogsByPawn = new Dictionary<string, List<ApiLog>>();
        ...
        // Constants: Overlay View
        private const float OverlayRowHeight = 22f;
        private const float OverlayPawnNameWidth = 90f;
