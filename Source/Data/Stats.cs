...
namespace RimTalk.Data
{
    public static class Stats
    {
        ...
        public static readonly List<long> TokensPerMinuteHistory = new List<long>();
        public static readonly List<long> CallsPerMinuteHistory = new List<long>();
        public static readonly List<long> AvgTokensPerCallHistory = new List<long>();

        // Per-second historical data (last 60 seconds)
        public static readonly List<long> TokensPerSecondHistory = new List<long>();
        public static readonly List<long> AvgTokensPerCallPerSecondHistory = new List<long>();
